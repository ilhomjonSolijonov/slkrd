...
// const readingGoogleSheet = () => {
//     const Name = document.querySelector('.inputname').value;
//     const Email = document.querySelector('.inputemail').value;
//     const Number1 = document.querySelector('.inputnumber').value;
//     const linkedin = document.querySelector('.inputlink').value;

//     fetch('https://sheetdb.io/api/v1/awd0lrxp0mvsw', {
//         method: 'POST',
//         headers: {
...
const questionFunc = () =>{
    const question = document.querySelector('.mil-question-p')
    question.classList.toggle('mil-question-active')
}